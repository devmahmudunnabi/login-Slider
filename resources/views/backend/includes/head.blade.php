        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">{{ Auth::user()?Auth::user()->name : 'DADU' }}</span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname">{{ Auth::user()?Auth::user()->name : 'DADU' }}</h6>
                <p>{{ Auth::user()?Auth::user()->email : 'DADU@mail.com' }}</p>
              </div>
              <hr>
              <div class="tx-center">
              ...
              <ul class="list-unstyled user-profile-nav">
                ...
                <form action="{{Route('logout')}}" method="post">
                   @csrf
                   <li><button class="border border-none btn btn-primary"><i class="icon ion-power"></i> Sign Out</button></li>
                </form>
